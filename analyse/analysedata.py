...
def analyse(filelist):
    ...
    for cut in cutlist:
        ...
        m2lhistlist.append(ROOT.TH1F('m2l'+ cut, "dileptonmass; invmass; events", 40, 0, 120000))
    ...
    for bestand in filelist:
        ...
        for event in range(number_entries):
            ...
            m2lhistlist[1].Fill(zmass1)
            m2lhistlist[1].Fill(zmass2)
            m4lhistlist[1].Fill(m4l)

            if leptonfilter == True:
                continue
            m2lhistlist[2].Fill(zmass1)
            m2lhistlist[2].Fill(zmass2)
            m4lhistlist[2].Fill(m4l)

            if jetfilter == True:
                continue
            m2lhistlist[3].Fill(zmass1)
            m2lhistlist[3].Fill(zmass2)
            m4lhistlist[3].Fill(m4l)

            if ptfilter == True:
                continue
            m2lhistlist[4].Fill(zmass1)
            m2lhistlist[4].Fill(zmass2)
            m4lhistlist[4].Fill(m4l)

            if istight == False:
                continue
            m2lhistlist[5].Fill(zmass1)
            m2lhistlist[5].Fill(zmass2)
            m4lhistlist[5].Fill(m4l)


    b = ROOT.TFile.Open('/user/ksmits/BachelorProject/analyse/{}'.format('datastacked.root'), "RECREATE")
    b.cd()
