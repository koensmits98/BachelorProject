...
def vergelijk(bestand):
    ...
    for event in range(1000):
        ...
        for j in range(4):
            ...
            hist.Fill(tree.lep_tracksigd0pvunbiased[j])
    
    
    imagename = 'sigmatrackd0{}.jpg'.format(bestand)
    hist.Draw()
    canvas.Print(imagename)

vergelijk('mc_361106.Zee.4lep.root')
vergelijk('mc_361107.Zmumu.4lep.root')
vergelijk('mc_345060.ggH125_ZZ4lep.4l# vergelijk('mc_345336.ZH125J_qqWW2lep.4lep.root')
